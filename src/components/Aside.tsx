...
export function Aside({asideArea}:{asideArea?:any}){
  ...
  let mobileStyles = 'z-10 absolute left-0 w-[75%] lg:w-[25%] h-full'

  return(
        <aside className={asideArea+' lg:relative bg-gray-50 lg:w-[30%] border border-solid lg:block flex-col p-2'+mobileStyles}>
